#Conciencia de Codigo

Jogo interativo criado para a disciplina MAT68 - Computador, Ética e Sociedade (COMPUSOC). UFBA.
...
Liberdade 0 (Rodar): Usar o programa para qualquer propósito.
Liberdade 1 (Estudar): Acessar e analisar o código.
Liberdade 2 (Redistribuir): Compartilhar cópias com outros.
Liberdade 3 (Melhorar/Aplicar): Modificar e aplicar o conhecimento para o bem coletivo.
...
Leitura: Leia atentamente o cenário e as falas.
Escolha: No final de cada segmento, aparecerá um ou mais botões com opções de ação.
Progresso: Clique na opção desejada para avançar na história. Suas escolhas (especialmente nos dilemas com o Sapo que Lava Dinheiro) determinam o seu sucesso.
Objetivos
...
Abra o Arquivo: Simplesmente abra o arquivo index.html em qualquer navegador moderno (Chrome, Firefox, Edge, etc.).
Comece a Jogar!
